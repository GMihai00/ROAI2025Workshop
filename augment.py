...
prompt = ["A human-rabbit hybrid disney princess in a fantasy world, 4k, detailed, trending in artstation, fantasy vivid colors. She has small eyes and is eating a carrot"]
...
images[0].save("rabbit_princess.png")